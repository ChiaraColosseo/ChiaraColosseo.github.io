...
var progetti = {
    'the-goodslift': {
        ...
        descrizioneBreve: "PROVA La routine di un uomo viene spezzata da un incredibile viaggio nel passato.",
        descrizioneLunga: "PROVA Cortometraggio realizzato da un gruppo di giovani studenti cineasti. Un uomo entra in un ascensore e compirà un viaggio attraverso momenti salienti della sua vita, mentre una figura misteriosa lo attende. (Durata: 5')",
        ruolo: 'Segretaria di edizione, assistente al montaggio video-audio',
        tipo: 'PROVA Progetto di gruppo',
        software: ['premiere'],
